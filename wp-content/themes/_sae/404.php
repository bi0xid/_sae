		...
		<div id="content" class="site-content" role="main">
			...
			<article id="post-0" class="post not-found">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'Oops! That page can&rsquo;t be found.', '_sae' ); ?></h1>
				</header><!-- .entry-header -->
				...
				<div class="entry-content">
					...
					<div class="widget widget_categories">
						<h2 class="widgettitle"><?php _e( 'Most Used Categories', '_sae' ); ?></h2>
						<ul>
						<?php
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', '_sae' ), convert_smilies( ':)' ) ) . '</p>';
